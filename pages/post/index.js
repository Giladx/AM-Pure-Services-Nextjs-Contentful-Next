...
import postPageInitialPropsC6e56Resource from '../../resources/post-page-initial-props-c6e56'
      ...
      <div className="post1-container">
        ...
        <div className="post1-posts-componnets">
          <div className="post1-container1">
            <span className="post1-text">from blog</span>
            <h2 className="post1-text01 Heading2">
...
export async function getStaticProps(context) {
  try {
    const response = await postPageInitialPropsC6e56Resource({
      ...context?.params,
    })
    if (!response) {
      return {

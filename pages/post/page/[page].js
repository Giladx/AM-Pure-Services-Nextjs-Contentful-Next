...
import postPageInitialPaths6c289Resource from '../../../resources/post-page-initial-paths-6c289'
import postPageInitialProps330bbResource from '../../../resources/post-page-initial-props-330bb'
      ...
      <div className="post11-container">
        ...
        <div className="post11-posts-componnets">
          <div className="post11-container1">
            <span className="post11-text">from blog</span>
            <h2 className="post11-text01 Heading2">
...
export async function getStaticPaths() {
  try {
    const response = await postPageInitialPaths6c289Resource({
      content_type: 'post',
    })
...
export async function getStaticProps(context) {
  try {
    const response = await postPageInitialProps330bbResource({
      ...context?.params,
